      ...
      <View style={styles.buttonsContainer}>
        <View style={styles.buttons}>
          <Buttons
            value={"AC"}
            colorText={"white"}
            color={"#B004C4"} size={70} fun={() => deleteAll()} />
          <Buttons
            value={"<-"}
            fun={() => deleteByOne()}
            colorText={"white"}
            color={"#B004C4"} size={70}
            icon={<FontAwesome6 name="delete-left" size={24} color="white" />} />
          <Buttons
            value={"%"}
            colorText={"white"}
            color={"#B004C4"} size={70} fun={() => porcentage()} />
          <Buttons
            value={"/"}
            fun={() => show("/")}
            colorText={"white"}
            color={"#04C4C4"} size={70} />
        </View>
        ...
        <View style={styles.buttons}>
          ...
          <Buttons
            value={"="}
            colorText={"white"}
            color={"#04C4C4"} size={70} fun={() => result()} />
        </View>
